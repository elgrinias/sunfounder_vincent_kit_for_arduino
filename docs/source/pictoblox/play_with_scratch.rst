...
Επιπρόσθετα, περιλαμβάνει Τεχνητή Νοημοσύνη (TN) και Μηχανική Μάθηση (ΜΜ) και επομένως, ακόμα κι αν δεν έχετε βάσεις προγραμματισμού, σας δίνεται η δυνατότητα να μάθετε και να χρησιμοποιήσετε αυτά τα δημοφιλή και υψηλής τεχνολογίας πεδία της Πληροφορικής.
...
Αλλά για το έργο :ref:`humiture` απαιτείται η χρήση του :ref:`Upload Mode`.
