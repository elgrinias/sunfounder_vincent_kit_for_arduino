...
Επιπρόσθετα, περιλαμβάνει Τεχνητή Νοημοσύνη (TN) και Μηχανική Μάθηση (ΜΜ) και επομένως, ακόμα κι αν δεν έχετε βάσεις προγραμματισμού, σας δίνεται η δυνατότητα να γνωρίσετε αυτά τα δημοφιλή και υψηλής τεχνολογίας πεδία της Πληροφορικής.

Απλώς σύρετε και εναποθέστε τα μπλοκ κώδικα του Scratch και δημιουργήστε διασκεδαστικά παιχνίδια, κινούμενα σχέδια, αλληλοδραστικά έργα και, ακόμα, ελέγξτε τα ρομπότ με όποιον τρόπο θέλετε!
